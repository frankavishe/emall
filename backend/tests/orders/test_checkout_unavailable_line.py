...
def test_checkout_blocks_on_unpublished_line(api_client):
    ...
    # Vendor unpublishes the product after it was added to the cart.
    ...
    assert response.data["lines"] == [
        {"cart_item_id": cart_item.id, "reason": "no longer published"}
    ]
